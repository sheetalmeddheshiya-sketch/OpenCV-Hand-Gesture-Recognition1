...
MODEL_PATH = ROOT / "models" / "gesture_model.joblib"
METADATA_PATH = ROOT / "models" / "gesture_model.json"
...
def load_model():
    if not MODEL_PATH.exists():
        raise FileNotFoundError("Model missing. Run `python train_model.py` first.")
